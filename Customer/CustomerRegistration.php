...
if (isset($_REQUEST['rSignup'])) {
 ...
 if (($_REQUEST['rName'] == "") || ($_REQUEST['rEmail'] == "") || ($_REQUEST['rPassword'] == "") || ($_REQUEST['rPhone'] == "") || ($_REQUEST['rAddress'] == "") || ($_REQUEST['rPreference'] == "")) {
  ...
  if ($result->num_rows == 1) {
   ...
   $rPreference = $_REQUEST['rPreference'];
   if ($_FILES['f1']['name']) {
    move_uploaded_file($_FILES['f1']['tmp_name'], "image/" . $_FILES['f1']['name']);
    $img = "image/" . $_FILES['f1']['name'];
   }
   $sql = "INSERT INTO customerlogin_tb(c_name, c_email, c_password, c_address, c_preference, c_phone, c_image) VALUES ('$rName','$rEmail', '$rPassword', '$rAddress', '$rPreference', $rPhone, '$img')";
        ...
        <div class="row mt-4 mb-4">
            <div class="col-md-6 offset-md-3">
                <form action="" class="shadow-lg p-4" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <i class="fas fa-phone"></i><label for="phone" class="pl-2 font-weight-bold">Phone</label><input
                            type="tel" class="form-control" placeholder="PhoneNo" name="rPhone">
                    </div>
